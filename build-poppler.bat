...
cmake .. -G "MinGW Makefiles" -DCMAKE_INSTALL_PREFIX=install %OPTIONAL_DISABLES% %PKG_CONFIG_OPTIONS% %CAIRO_OPTIONS% %FREETYPE_OPTIONS% %ZLIB_OPTIONS% %LIBJPEG_OPTIONS% %OPENJPEG_OPTIONS% %LIBPNG_OPTIONS% %LIBTIFF_OPTIONS%
